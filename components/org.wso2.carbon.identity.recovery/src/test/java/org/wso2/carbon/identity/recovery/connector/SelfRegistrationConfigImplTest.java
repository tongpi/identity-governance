...
public class SelfRegistrationConfigImplTest {
        ...
        public void testGetCategory() {
                assertEquals(selfRegistrationConfigImpl.getCategory(), "账号管理策略");
        }
        ...
        public void testGetPropertyNameMapping() {
                ...
                nameMappingExpected.put(LIST_PURPOSE_PROPERTY_KEY, "管理自主注册的目的");
        ...
        public void testGetPropertyDescriptionMapping() {
                ...
                descriptionMappingExpected.put(LIST_PURPOSE_PROPERTY_KEY, "点击这里管理自主注册的目的");
        ...
        public void testGetPropertyNames() {
                ...
                propertiesExpected
                                .add(IdentityRecoveryConstants.ConnectorConfig.SIGN_UP_NOTIFICATION_INTERNALLY_MANAGE);
        ...
        public void testGetDefaultPropertyValues() throws IdentityGovernanceException {
                ...
                propertiesExpected.put(IdentityRecoveryConstants.ConnectorConfig.ENABLE_SELF_SIGNUP,
                ...
                try {
                        propertiesExpected.put(LIST_PURPOSE_PROPERTY_KEY, consentListURL + "&callback="
        ...
        public void testGetDefaultProperties() throws IdentityGovernanceException {
                ...
                Map<String, String> defaultPropertyValues = selfRegistrationConfigImpl
