...
public class UserEmailVerificationConfigImplTest {
        ...
        public void testGetDefaultPropertyValues() throws IdentityGovernanceException {
                ...
                try {
                        defaultPropertiesExpected.put(LIST_PURPOSE_PROPERTY_KEY, CONSENT_LIST_URL + "&callback="
                                        + URLEncoder.encode(CALLBACK_URL, StandardCharsets.UTF_8.name()));
                } catch (UnsupportedEncodingException e) {
                        throw new IdentityGovernanceException("Error while url encoding callback url: " + CALLBACK_URL,
                                        e);
                }
        ...
        public void testGetDefaultProperties() throws IdentityGovernanceException {
                ...
                Map<String, String> defaultPropertyValues = userEmailVerificationConfig
